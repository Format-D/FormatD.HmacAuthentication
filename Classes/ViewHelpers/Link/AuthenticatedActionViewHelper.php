<?php
namespace FormatD\HmacAuthentication\ViewHelpers\Link;
 ...
 *
 * Same as the original one but adds credentials (a hmac) to authenticate
 *
 * = Examples =
 *
 * <code title="Defaults">
 * <f:link.authenticatedAction>some link</f:link.authenticatedAction>
 * </code>
 * <output>
 * <a href="currentpackage/currentcontroller?__authentication[FormatD][HmacAuthentication][authToken]=*credentialsForAuthentication*">some link</a>
 * (depending on routing setup and current package/controller/action)
 * </output>
 *
 * <code title="Additional arguments">
 * <f:link.authenticatedAction action="myAction" controller="MyController" package="YourCompanyName.MyPackage" subpackage="YourCompanyName.MySubpackage" arguments="{key1: 'value1', key2: 'value2'}">some link</f:link.authenticatedAction>
 * </code>
 * <output>
 * <a href="mypackage/mycontroller/mysubpackage/myaction?key1=value1&amp;key2=value2&__authentication[FormatD][HmacAuthentication][authToken]=*credentialsForAuthentication*">some link</a>
 * (depending on routing setup)
 * </output>
 *
 * @api
 */
class AuthenticatedActionViewHelper extends AbstractTagBasedViewHelper
{
